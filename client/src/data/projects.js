export const projects = [
  // Tier 1 — Featured case studies
  {
    ...
    image: "/assets/research-atlas-reader.webp",
    images: [
      { src: "/assets/research-atlas-reader.webp", caption: "Three-pane reader — structured notes, the PDF with persistent highlights, and the grounded-Q&A assistant rail" },
      { src: "/assets/research-atlas-passage.webp", caption: "Passage breakdown with rendered equations, page-linked to the source PDF" },
      { src: "/assets/research-atlas-dashboard.webp", caption: "Dashboard — library stats, reading queue, open questions, and a 14-day activity view" },
      { src: "/assets/research-atlas-radar.webp", caption: "Research Radar — what to read next, inferred from your own library with a reason per candidate" },
      { src: "/assets/research-atlas-misconceptions.webp", caption: "Misconceptions & corrections — a durable record of how your understanding actually improved" },
    ],
